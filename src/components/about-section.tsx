...
const TimelineItem = ({ item, isVisible }: { item: typeof experienceData[0], isVisible: boolean }) => {
  return (
    <div className={`flex items-start gap-6 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <div className="pb-12">
        <div className="bg-card text-card-foreground rounded-lg shadow-lg p-6 -mt-2 transition-all duration-300 ease-in-out border-2 border-transparent hover:border-primary hover:scale-[1.07] hover:-translate-y-1 hover:shadow-2xl">
